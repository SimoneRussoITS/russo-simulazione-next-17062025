...
const reasons = [
  {
    ...
    description:
      "Oltre 10 anni di esperienza nel settore della trasformazione digitale con un track record di successi documentati.",
  },
  {
    id: 2,
    icon: "fas fa-rocket",
  ...
  },
  {
    ...
    title: "ROI Garantito",
    description:
      "Approccio data-driven e metodologie comprovate per assicurare un ritorno sull'investimento misurabile e concreto.",
  },
]
          ...
          <div className="row mb-5">
            <div className="col-lg-8 mx-auto text-center">
              <h2 id="why-choose-title" className="display-4 fw-bold mb-4">
                Perché Scegliere <span className="text-primary">TechFlow</span>
              </h2>
              <p className="lead text-muted">
                Siamo il partner ideale per la tua trasformazione digitale grazie alla nostra esperienza, innovazione e
                approccio centrato sui risultati.
              </p>
            </div>
          </div>
